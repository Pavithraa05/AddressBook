...
for (int i = 0; i < n - 1; i++)
{
    for (int j = 0; j < n - i - 1; j++)
    {
        ...
        if (sortCriteria == 1) // Name
            cmp = strcmp(addressBook->contacts[j].name,
                         addressBook->contacts[j+1].name);

        else if (sortCriteria == 2) // Phone
            cmp = strcmp(addressBook->contacts[j].phone,
                         addressBook->contacts[j+1].phone);

        else if (sortCriteria == 3) // Email
            cmp = strcmp(addressBook->contacts[j].email,
...
void searchContact(AddressBook *addressBook)
{
    ...
    {
        char key[50];
        printf("Enter the name:");                               // Search key
    ...
    {
        char key[50];  
        printf("Enter the phone number:");                              // Phone key
    ...
    {
        char key[50]; 
        printf("Enter the email address:");                               // Email key
...
void editContact(AddressBook *addressBook)
{
    ...
    if (choice == 1)                               // Edit name
    {
        ...
        printf("Enter old name:");            // Buffers
        scanf("%s", oldName); 
        printf("Enter new name:");                      // Old name
        getchar();                                 // Clear buffer
        scanf("%[^\n]", newName);                  // New name
    ...
    else if (choice == 3)                          // Edit email
    {
        ...
        printf("Enter old eamil address:"); 
        scanf("%s", oldEmail);
        printf("Enter new eamil address:"); 
        scanf("%s", newEmail);
...
void deleteContact(AddressBook *addressBook)
{
    ...
    {
        char key[50];
        printf("Enter the eamil address to delete:"); 
        scanf("%s", key);
