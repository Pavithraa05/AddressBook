#include "contact.h"
// Dummy contact data used for initial population
...
{
    // Calculate number of dummy contacts available
    int numDummyContacts = sizeof(dummyContacts) / sizeof(dummyContacts[0]);
    // Copy dummy contacts into address book until limit is reached
